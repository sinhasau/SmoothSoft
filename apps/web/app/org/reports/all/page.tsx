...
export default function AllStoresReportPage() {
  ...
  if (!data) return <p className="px-6 py-8 text-sm text-gray-500">Building the combined report…</p>;
  const financial = [
